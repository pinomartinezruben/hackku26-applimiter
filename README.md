...
6:49 AM--
Made these changes to relect me wanting to have the search bar not show literally every app by default, and trying to show each app and its image via kotlin back end:
...
Made changes to new_limiter_page to reflect the icon stuff:
